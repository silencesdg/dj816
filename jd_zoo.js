...
$.secretpInfo = {};
$.innerPkInviteList = [
  'sSKNX-MpqKOJsNu8n5PcVgAm_hiCTFd66yPN_IAHBmmnqybcbQNy4RKl8qFMQY-u'
];
...
!(async () => {
  ...
  res3 = await getAuthorShareCode('https://cdn.jsdelivr.net/gh/asd920/updateTeam@master/shareCodes/jd_zoo.json');
  res = await getAuthorShareCode('https://ghproxy.com/https://raw.githubusercontent.asd920/updateTeam/main/shareCodes/jd_zoo.json');
  if (pKHelpAuthorFlag) {
